...
from ask_llm.memory.embeddings import generate_embedding
from ask_llm.utils.config import Config

if TYPE_CHECKING:
    from ask_llm.memory.postgresql import PostgreSQLShortTermManager
...
class MemoryStorage:
    ...
    async def consolidate_memories(
        ...
        """
        from ask_llm.memory.consolidation import MemoryConsolidator, get_local_llm_client
    ...
    async def update_memory_meaning(
        ...
        if not memory_id:
            return False
        from ask_llm.memory.maintenance import update_memory_meaning
    ...
    async def run_maintenance(
        ...
        from ask_llm.memory.maintenance import MemoryMaintenance
