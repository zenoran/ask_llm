...
if TYPE_CHECKING:
    from ask_llm.memory_server.storage import MemoryStorage
...
class MemoryClient:
    ...
    def _ensure_initialized(self) -> None:
        ...
        if self.server_url:
            ...
            from ask_llm.memory_server.storage import get_storage
    ...
    def _call_server(self, method: str, params: dict) -> Any:
        ...
        request_id = None
        try:
            from ask_llm.service.logging import get_request_id  # type: ignore
        ...
        try:
            from ask_llm.service.logging import get_service_logger
