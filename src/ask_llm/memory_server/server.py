...
Run standalone:
    uv run python -m ask_llm.memory_server
...
def run_server(
    ...
    verbose_env = os.getenv("ASK_LLM_MEMORY_SERVER_VERBOSE", "1").lower()
    debug_env = os.getenv("ASK_LLM_MEMORY_SERVER_DEBUG", "0").lower()
