"""Migration utilities for ask_llm memory schema changes.

Run from command line:
    python -m ask_llm.memory.migrations backfill_meaning --bot nova
    python -m ask_llm.memory.migrations all --bot nova

Or import and use programmatically:
    from ask_llm.memory.migrations import run_all_migrations
