...
class LegacyXMLFormatHandler(ToolFormatHandler):
    ...
    def get_system_prompt(self, tools: list) -> str:
        from ask_llm.tools.definitions import get_tools_prompt
    ...
    def parse_response(self, response: str) -> tuple[list[ToolCallRequest], str]:
        from ask_llm.tools.parser import parse_tool_calls
    ...
    def format_result(
        ...
        from ask_llm.tools.parser import format_tool_result
