...
from ask_llm.utils.config import Config, set_config_value
from ask_llm.utils.env import set_env_value
...
def run_config_wizard(config: Config, console: Console) -> int:
    ...
    console.print(Panel.fit("ask_llm Config Wizard", border_style="cyan"))
