...
try:
    ...
    async def provision_nextcloud_talk(request: NextcloudProvisionRequest):
        """Provision a Nextcloud Talk room and bot for an ask_llm bot."""
    ...
    async def clear_history(
        ...
        try:
            ...
            ask_llm = service._get_ask_llm(model_alias, effective_bot_id, service.config.DEFAULT_USER)
