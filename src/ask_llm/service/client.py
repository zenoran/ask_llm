...
DEFAULT_SOCKET_PATH = Path.home() / ".cache" / "ask_llm" / "service.sock"
...
class ServiceClient:
    """
    Client for communicating with the ask_llm background service.
    ...
    async def _request_async(
        ...
        if not HTTPX_AVAILABLE:
            raise RuntimeError("httpx not available. Install with: pip install ask-llm[service]")
