...
from ask_llm.tools.formats import ToolFormat
from ask_llm.tools.formats.react import ReActFormatHandler
from ask_llm.tools.loop import ToolLoop
from ask_llm.tools.streaming import stream_with_tools
...
class TestToolLoopFullFlow:
    ...
    def test_tool_with_no_args_executes(self):
        ...
        with patch('ask_llm.tools.loop.ToolExecutor') as mock_executor_class:
            mock_executor = Mock()
...
class TestStreamingToolLoop:
    ...
    def test_streaming_yields_final_response(self):
        ...
        with patch('ask_llm.tools.streaming.ToolExecutor') as mock_executor_class:
            mock_executor = Mock()
