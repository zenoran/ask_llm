...
from ask_llm.memory_server.client import MemoryClient
from ask_llm.memory.extraction import MemoryExtractionService
from ask_llm.memory.profile_maintenance import ProfileMaintenanceService
from ask_llm.core.client import AskLLM
...
def main():
    ...
    try:
        # Create AskLLM instance to get the client
        ask_llm = AskLLM(
